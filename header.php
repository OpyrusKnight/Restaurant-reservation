...
<nav class="navbar navbar-expand-md navbar-light fixed-top">
		...
		<strong><em>Savourettes</em></strong>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navi">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="view_reservations.php" >Voir la réservation</a>
                    </li>';
                    ...
                    echo'
                    <li class="nav-item">
                        <a class="nav-link" href="schedule.php" >  Modifier emploi du temps</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="tables.php" >Modifier la table</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="view_tables.php" >Voir la Table</a>
                    </li>';    
                    }
                    }
                    ...
                    <li class="nav-item">
	                 <a class="nav-link" href="#aboutus">A propos de nous</a>
	             </li>
	            <li class="nav-item">
	                <a class="nav-link" href="#gallery">Restaurants</a>
	            </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#reservation">Réservation </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#footer">Trouvez-Nous</a>
                    </li>
                    '; } 
                    ?>
                    ...
                    <button type="submit" name="logout-submit" class="btn btn-outline-dark">Déconnexion</button>
                    </form>';
                    }
                    else{  
                    echo '
            ...
            <!-- Modal body -->
                ...
                if(isset($_GET['signup'])) { 
                    ...
                    if($_GET['signup'] == "success"){ 
                        echo '<h5 class="bg-success text-center">inscription a été effectuée avec succès ! Veuillez vous connecter !</h5>';
                    }
                }
                echo'<br>';
                ?>
    ...
    <!---sign up form -->
                    <div class="signup-form">
                        <form action="includes/signup.inc.php" method="post">
                            ...
                            <div class="form-group">
                                <label class="checkbox-inline"><input type="checkbox" required="r equired">  J'accepte les <a href="#">Conditions d'utilisation</a> &amp; <a href="#"> et la Politique de confidentialité</a></label>
                            </div>
                            <div class="form-group">
                                <button type="submit" name="signup-submit" class="btn btn-dark btn-lg btn-block">S'inscrire maintenant</button>
                            </div>
                        </form>
                            <div class="text-center">Vous avez déjà un compte ? <a href="#">Connectez-vous</a></div>
                    </div> 	
                </div>        
                <!-- Modal footer -->
                <div class="modal-footer">
